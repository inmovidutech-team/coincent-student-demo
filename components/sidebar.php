<div class="main-section">
    <div class="sidebar side-fix" style="display:none" id="mySidebar">
        ...
        <div class="bar-container">
            <ul>
                ...
                <li><a href="training.php" class="bar-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                            class="bi bi-person-fill" viewBox="0 0 16 16">
                            <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                        </svg>
                        Training</a></li>
                <li><a href="project.php" class="bar-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                        ...
                        Projects</a></li>
                <li><a href="internship.php" class="bar-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                        ...
                        Internship</a></li>
                <li><a href="certificate.php" class="bar-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                        ...
                        Certificate</a></li>
                <li><a href="referral.php" class="bar-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                        ...
                        Referral</a></li>
                <li><a href="lms.php" class="bar-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                        ...
                        LMS</a></li>
                <li><a href="resume-builder.php" class="bar-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                            class="bi bi-mortarboard-fill" viewBox="0 0 384 512">
                            <path
